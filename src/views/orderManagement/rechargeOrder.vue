        ...
        methods: {
            ...
            exportExcel () {   //导出excel
                if (this.selectData.length) {
                    ...
                    const params = {
                        title: ['时间', '店铺名称', '会员名称','手机号码','会员等级','总额','现金支付','收益余额30%','状态','支付方式','推广会员'],
                        key: ['orderTime', 'shopName', 'userName','phone','levelName','totalMoney','cashPay','incomeBalancePay','status','payMode','recommenderName'],
